...
# Scénario: Vérification de la durée au workflow collaborateur manager
...
Feature: Absences
  ...
  Scenario: Vérification de la durée au workflow collaborateur manager
   ...
   #Sélection des jours de repos
    ...
    And l utilisateur saisit "CPW1D1" dans le champs "Code_Ajout_Motif_Abcences"
    ...
    And l utilisateur clique sur "Rubrique_Motifs_absence"
    And l utilisateur clique sur "Ajouter_motif"
    And l utilisateur saisit "CPW1D2" dans le champs "Code_Ajout_Motif_Abcences"
   ...
   #Etape 9 : Profil manager-Validation de demande d'absence
    ...
    And l utilisateur clique sur "Rubrique_Motifs_absence"
    And l utilisateur clique sur "Ajouter_motif"
    And l utilisateur saisit "CPW1D3" dans le champs "Code_Ajout_Motif_Abcences"
